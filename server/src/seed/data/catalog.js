export const CATEGORIES = [
  { name: 'Cakes', slug: 'cakes', icon: 'cakes', accent: { from: '#FFE3EC', to: '#FFF4E6' }, description: 'Freshly baked, delivered in the hour.', isFeatured: true },
  { name: 'Flowers', slug: 'flowers', icon: 'flowers', accent: { from: '#FFE0E6', to: '#FFF0F3' }, description: 'Hand-tied bouquets from local florists.', isFeatured: true },
  { name: 'Chocolates', slug: 'chocolates', icon: 'chocolates', accent: { from: '#F5E6D8', to: '#FFF6EC' }, description: 'Artisan chocolate, made close to you.', isFeatured: true },
  { name: 'Gift Hampers', slug: 'gift-hampers', icon: 'gift-hampers', accent: { from: '#FDE8D7', to: '#FFF7EE' }, description: 'Beautifully curated, ready to gift.', isFeatured: true },
  { name: 'Personalized Gifts', slug: 'personalized-gifts', icon: 'personalized-gifts', accent: { from: '#F0E6FF', to: '#FAF5FF' }, description: 'Add a name, a photo, a memory.', isFeatured: true },
  { name: 'Soft Toys', slug: 'soft-toys', icon: 'soft-toys', accent: { from: '#FFEFD9', to: '#FFF9F0' }, description: 'Cuddly companions for every age.', isFeatured: true },
  { name: 'Anniversary Gifts', slug: 'anniversary-gifts', icon: 'anniversary-gifts', accent: { from: '#FFE5EC', to: '#FFF5F8' }, description: 'For the years you have shared.' },
  { name: 'Birthday Gifts', slug: 'birthday-gifts', icon: 'birthday-gifts', accent: { from: '#E6F4FF', to: '#F5FBFF' }, description: 'Make their day unforgettable.' },
  { name: "Mother's Day", slug: 'mothers-day', icon: 'mothers-day', accent: { from: '#FFE9F0', to: '#FFF6F9' }, description: 'Because she never asks for anything.' },
  { name: "Father's Day", slug: 'fathers-day', icon: 'fathers-day', accent: { from: '#E8F0FF', to: '#F6F9FF' }, description: 'For the quiet hero at home.' },
  { name: "Valentine's Day", slug: 'valentines-day', icon: 'valentines-day', accent: { from: '#FFE1E6', to: '#FFF2F4' }, description: 'Say it properly this year.' },
  { name: 'Wedding Gifts', slug: 'wedding-gifts', icon: 'wedding-gifts', accent: { from: '#FFF3DC', to: '#FFFBF3' }, description: 'Elegant gifting for the big day.' },
  { name: 'Baby Gifts', slug: 'baby-gifts', icon: 'baby-gifts', accent: { from: '#E8F8F5', to: '#F5FFFD' }, description: 'Welcome the newest arrival.' },
  { name: 'Corporate Gifts', slug: 'corporate-gifts', icon: 'corporate-gifts', accent: { from: '#EEF0F5', to: '#F9FAFC' }, description: 'Thoughtful gifting, at scale.' },
  { name: 'Festival Gifts', slug: 'festival-gifts', icon: 'festival-gifts', accent: { from: '#FFF0D9', to: '#FFFAF0' }, description: 'Diwali, Rakhi, Eid and everything between.' },
